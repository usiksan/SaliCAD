#ifndef SDW3DMODELPROGRAMMEDITOR_H
#define SDW3DMODELPROGRAMMEDITOR_H
...
//Текстовый редактор
class SdW3dModelProgrammEditor : public QPlainTextEdit {
    Q_OBJECT
  ...
  public:
    ...
    virtual ~SdW3dModelProgrammEditor();
...
class LineNumberArea : public QWidget
  {
  public:
    LineNumberArea(SdW3dModelProgrammEditor *editor) : QWidget(editor) {
      codeEditor = editor;
      }
  ...
  private:
    SdW3dModelProgrammEditor *codeEditor;
  };

#endif // SDW3DMODELPROGRAMMEDITOR_H

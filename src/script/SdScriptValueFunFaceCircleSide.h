...
class SdScriptValueFunFaceCircleSide : public SdScriptValueFunction
  {
    Sd3dModel *mModel;
  public:
    SdScriptValueFunFaceCircleSide( Sd3dModel *model ) : SdScriptValueFunction( SD_SCRIPT_TYPE_FACE, SD_SCRIPT_TYPE_FLOAT, SD_SCRIPT_TYPE_FLOAT, SD_SCRIPT_TYPE_MATRIX ), mModel(model) { }

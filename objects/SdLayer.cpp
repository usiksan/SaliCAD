...
SdLayerLevel sdLayerLevel0[] = {
  { LID0_COMMON,        QT_TR_NOOP( "Common" ), 0 },
  { LID0_INVISIBLE,     QT_TR_NOOP( "Invisible" ), 0 },

  //Schematic specific
  { LID0_NET,           QT_TR_NOOP( "Schematic net" ), 0 },
  { LID0_NET_NAME,      QT_TR_NOOP( "Schematic net name" ), 0 },
  { LID0_BUS,           QT_TR_NOOP( "Schematic net bus" ), 0 },
  { LID0_AREA,          QT_TR_NOOP( "Schematic pcb area contour" ), 0 },

  //PCB specific
  { LID0_PCB,           QT_TR_NOOP( "PCB contour" ), 0 },
  { LID0_WIRE,          QT_TR_NOOP( "PCB wire" ), 0 },
  { LID0_POLYGON,       QT_TR_NOOP( "PCB polygon" ), 0 },
  { LID0_PAD,           QT_TR_NOOP( "PCB pad" ), 0 },
  ...
  //Both schematic and PCB
  { LID0_COMPONENT,     QT_TR_NOOP( "Component" ), 0 },
  { LID0_PIN,           QT_TR_NOOP( "Pin" ), 0 },
  { LID0_PIN_NAME,      QT_TR_NOOP( "Pin name" ), 0 },
  { LID0_PIN_NUMBER,    QT_TR_NOOP( "Pin number" ), 0 },
  { LID0_IDENT,         QT_TR_NOOP( "Component ident" ), 0 },
  { LID0_PICTURE,       QT_TR_NOOP( "Picture" ), 0 },
  { LID0_REMARK,        QT_TR_NOOP( "Remark" ), 0 },
  { LID0_VALUE,         QT_TR_NOOP( "Value" ), 0 },
  { LID0_CONTOUR,       QT_TR_NOOP( "Contour" ), 0 },
  { nullptr, nullptr, 0 }
};
...
SdLayerLevel sdLayerLevel1[] = {
  { "",                 QT_TR_NOOP( "---" ), stmThrough },
  { LID1_TOP,           QT_TR_NOOP( "on top" ), stmTop },
  { LID1_BOT,           QT_TR_NOOP( "on bottom" ), stmBottom },
  { LID1_INT00,         QT_TR_NOOP( "on internal 1" ), stmInt00 },
  { LID1_INT01,         QT_TR_NOOP( "on internal 2" ), stmInt01 },
  { LID1_INT02,         QT_TR_NOOP( "on internal 3" ), stmInt02 },
  { LID1_INT03,         QT_TR_NOOP( "on internal 4" ), stmInt03 },
  { LID1_INT04,         QT_TR_NOOP( "on internal 5" ), stmInt04 },
  { LID1_INT05,         QT_TR_NOOP( "on internal 6" ), stmInt05 },
  { LID1_INT06,         QT_TR_NOOP( "on internal 7" ), stmInt06 },
  { LID1_INT07,         QT_TR_NOOP( "on internal 8" ), stmInt07 },
  { LID1_INT08,         QT_TR_NOOP( "on internal 9" ), stmInt08 },
  { LID1_INT09,         QT_TR_NOOP( "on internal 10" ), stmInt09 },
  { LID1_INT10,         QT_TR_NOOP( "on internal 11" ), stmInt10 },
  { LID1_INT11,         QT_TR_NOOP( "on internal 12" ), stmInt11 },
  { LID1_INT12,         QT_TR_NOOP( "on internal 13" ), stmInt12 },
  { LID1_INT13,         QT_TR_NOOP( "on internal 14" ), stmInt13 },
  { LID1_INT14,         QT_TR_NOOP( "on internal 15" ), stmInt14 },
  { LID1_INT15,         QT_TR_NOOP( "on internal 16" ), stmInt15 },
  { LID1_INT16,         QT_TR_NOOP( "on internal 17" ), stmInt16 },
  { LID1_INT17,         QT_TR_NOOP( "on internal 18" ), stmInt17 },
  { LID1_INT18,         QT_TR_NOOP( "on internal 19" ), stmInt18 },
  { LID1_INT19,         QT_TR_NOOP( "on internal 20" ), stmInt19 },
  { LID1_INT20,         QT_TR_NOOP( "on internal 21" ), stmInt20 },
  { LID1_INT21,         QT_TR_NOOP( "on internal 22" ), stmInt21 },
  { LID1_INT22,         QT_TR_NOOP( "on internal 23" ), stmInt22 },
  { LID1_INT23,         QT_TR_NOOP( "on internal 24" ), stmInt23 },
  { LID1_INT24,         QT_TR_NOOP( "on internal 25" ), stmInt24 },
  { LID1_INT25,         QT_TR_NOOP( "on internal 26" ), stmInt25 },
  { LID1_INT26,         QT_TR_NOOP( "on internal 27" ), stmInt26 },
  { LID1_INT27,         QT_TR_NOOP( "on internal 28" ), stmInt27 },
  { nullptr, nullptr, 0 }
};

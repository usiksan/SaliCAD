...
SdDRuleEditor::SdDRuleEditor(SdPItemPlate *plate, QWidget *parent) :
  ...
  //Fill pcb block
  ui->mPcbRoadWidth->setText( sdEnvir->toPhisPcb(mPcb.mRules[ruleRoadWidth]) );
  ui->mPcbPad2Pad->setText( sdEnvir->toPhisPcb(mPcb.mRules[rulePadPad]) );
  ui->mPcbRoad2Pad->setText( sdEnvir->toPhisPcb(mPcb.mRules[ruleRoadPad]) );
  ui->mPcbRoad2Road->setText( sdEnvir->toPhisPcb(mPcb.mRules[ruleRoadRoad]) );
...
void SdDRuleEditor::writeToLineEdit(int v, QLineEdit *edit)
  ...
  if( v < -1 )
    ...
    edit->setText( sdEnvir->toPhisPcb(v) );
  }
...
int SdDRuleEditor::readFromLineEdit(QLineEdit *edit, bool *isEmpty)
  ...
  *isEmpty = false;
  if( str.isEmpty() )
    return -2;
  return sdEnvir->fromPhisPcb( str );
  }
